using CodingChallenges.CrakingTheCodingInterviewLeetCode.Question0066;
...
namespace CodingChallenges.Test.CrakingTheCodingInterview.LeetCode
{
    public class Question0066
    {
        ...
        //{
        //    var result = Resolution.Solution1(test.Digits);
        ...
        {
            var result = Resolution.Solution2(test.Digits);
